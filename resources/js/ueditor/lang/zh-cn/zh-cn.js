...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'touppercase':'字母大写', 'tolowercase':'字母小写','background':'背景','template':'模板','scrawl':'涂鸦','music':'音乐','insertcmsarticle':'插入图文','insertcmsimage':'插入图集', 'insertcmsvideo':'插入视频控件','insertcmslink':'插入链接', 'insertcmsvote':'插入投票', 'insertcmscontent':'插入内容','insertcmschat':'插入语音','insertcmsactivity':'插入活动','insertcmsspecial':'插入专题','insertcmsshopguide':'插入导购','insertcmssurvey':'插入调查','inserttel':'插入电话号码'
    },
    'insertorderedlist':{
        'decimal':'1,2,3...',
        'lower-alpha':'a,b,c...',
