...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //获取CMS图集数据的地址
        ,getHiCmsUrl:URL+"../../../content/getContentList"

        //获取电商商品数据
        ,getGoodsUrl:URL+"../../../goods/asyncGetListToJson"

        //获取CMS图集数据的信息
        ,getContentInfo:URL+"../../../content/getContentInfo"
        
        //获取语音聊天列表
        ,getChatList:URL+"../../../chat/getChatList"
        //获取语音聊天信息
        ,getChatInfo:URL+"../../../chat/getChatInfo"
        
        //获取栏目数据
        ,getCataJson:URL+"../../../catalog/getTreeByJson"

        //保存投票信息
        ,saveVote:URL+"../../../contentVote/saveVote"

        //保存图集信息
        ,savePic:URL+"../../../content/add"

        //图片上传配置
        ,getComId:URL+"../../../content/getComId"
        ,uploadifySwf:URL+"../uploadify/uploadify.swf?ver=" + Math.random()

        //图片保存
        ,getPicUrl:URL+"../../../upload/uploadPic?var="+Math.random()
        ...
        ,toolbars:[
            [ 'source', '|', 'undo', 'redo', '|',
                ...
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','touppercase','tolowercase','|',
                 ...
                 'emotion',  'map', 'gmap', 'insertframe','highlightcode','template', '|',
                'horizontal', 'date', 'time','snapscreen', 'wordimage', '|',
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'print', 'preview', 'searchreplace',  '|',
             /*'insertcmsimage',*/ 'insertcmsvideo', /*'insertcmsvote',*/'insertcmscontent','insertcmschat','|','insertimage', 'link',  'inserttel' ]
        ]
        ...
        ,toolbars:[
            [ 'source', '|', 'undo', 'redo', '|',
                ...
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright','imagecenter', '|',
                 'emotion','scrawl',  'map', 'gmap', 'insertframe','highlightcode','template','background', '|',
                'horizontal', 'date', 'time','snapscreen', 'wordimage', '|',
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'print', 'preview', 'searchreplace',  '|',
             'insertcmsimage', 'insertcmsvideo', 'insertcmsvote', '|','insertimage', 'link',  'inserttel' ]
        ]
        */
        
        
        // ,toolbars:[
        //     ['bold', 'fontsize','forecolor', 'cleardoc',  '|',
        //      'insertcmsimage', 'insertcmsvideo', 'insertcmsvote', '|','insertimage', 'link',  'inserttel' ,]
        // ]
