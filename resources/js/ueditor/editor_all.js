...
//                img.style.cssText += ';margin:' + (first.margin||0) +"px;" + 'border:' + (first.border||0) +"px solid #000";
            ...
            if ( opt.length == 1 ) {
                str = '<img src="' + ci.src + '" ' + (ci.data_ue_src ? ' data_ue_src="' + ci.data_ue_src + '" ' : '') +
                        ...
                        (ci.onclick && ci.onclick != "" ? ' onclick = "' + ci.onclick + '"' : '') +
...
///import core
///import plugins\insertcmsimage.js
///commands 插入内容
///commandsName  insertcmsimage,insertcmsvideo,insertcmsvote,insertcmsactivity
///commandsTitle  插入图集,插入视频,插入投票,插入活动
///commandsDialog  dialogs\insertcmsimage\insertcmsimage.html,dialogs\insertcmsvideo\insertcmsvideo.html,dialogs\insertcmsvote\insertcmsvote.html,dialogs\insertcmsactivity\insertcmsactivity.html

UE.commands['insertcmsarticle'] =
UE.commands['insertcmsimage'] =
UE.commands['insertcmsvideo'] =
UE.commands['insertcmslink'] =
UE.commands['insertcmsvote'] =
UE.commands['insertcmscontent'] = 
UE.commands['insertcmschat'] =
UE.commands['insertcmsspecial'] =
UE.commands['insertcmsshopguide'] =
UE.commands['insertcmssurvey'] =
UE.commands['insertcmsactivity'] =
UE.commands['inserttel'] = {
    queryCommandState : function(){
        return this.highlight ? -1 :0;
    }
};
        ...
        getContentHtml: function (){
            ...
            if (typeof this.content == 'string') {
                ...
                contentHtml = '<span id="'+ this.id +'_contmask" class="dialogcontmask"></span><iframe id="'+ this.id +
                    '_iframe" class="%%-iframe" height="100%" width="95%" frameborder="0" src="'+ this.iframeUrl +'"></iframe>';
            }
            return contentHtml;
        },
        getHtmlTpl: function (){
            ...
            if (this.buttons) {
                ...
                /*footHtml = '<div class="%%-foot">' +
                    ...
                    '</div>';*/
                footHtml = '<div class="%%-foot">' +
                     '<div id="##_buttons" class="%%-buttons">' + '</div>' +
                    '</div>';
                var titleHtml = '<div id="##_buttons" class="%%-buttons">' + buff.join('') + '</div>';  //将确定与取消按钮添加到TitleBar中
            }
            return '<div id="##" class="%%"><div class="%%-wrap"><div id="##_body" class="%%-body">' +
                '<div class="%%-shadow"></div>' +
                '<div id="##_titlebar" class="%%-titlebar">' + titleHtml +
...
(function () {
    ...
    var iframeUrlMap = {
        ...
        'insertcmsarticle':'~/dialogs/insertcmsarticle/insertcmsarticle.html',
        'insertcmsimage':'~/dialogs/insertcmsimage/insertcmsimage.html',
        'insertcmsvideo':'~/dialogs/insertcmsvideo/insertcmsvideo.html',
        'insertcmslink':'~/dialogs/insertcmslink/insertcmslink.html',
        'insertcmsvote':'~/dialogs/insertcmsvote/insertcmsvote.html',
        'insertcmscontent':'~/dialogs/insertcmscontent/insertcmscontent.html',
        'insertcmschat':'~/dialogs/insertcmschat/insertcmschat.html',
        'insertcmsactivity':'~/dialogs/insertcmsactivity/insertcmsactivity.html',
        'insertcmsspecial':'~/dialogs/insertcmsspecial/insertcmsspecial.html',
        'insertcmsshopguide':'~/dialogs/insertcmsshopguide/insertcmsshopguide.html',
        'insertcmssurvey':'~/dialogs/insertcmssurvey/insertcmssurvey.html',
        'inserttel':'~/dialogs/inserttel/inserttel.html'
    };
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'highlightcode', 'insertframe', 'edittd', 'scrawl', 'template','music', 'background', 'insertcmsarticle', 'insertcmsimage', 'insertcmsvideo',  'insertcmslink', 'insertcmsvote','insertcmscontent','insertcmschat', 'insertcmsactivity', 'insertcmsspecial', 'insertcmsshopguide', 'insertcmssurvey', 'inserttel']
                                    ...
                                    switch (cmd) {
                                        ...
                                        case "insertcmscontent":
                                            ...
                                            openDialogComponent('添加内容', url, function() {
                                                // 直接把内容放到容器
                                                callbackDialogComponent('directSetConOrGoods', $("#link"));
                                            }, 600, 450);
                                            break;
                                        default:
                                            dialog.render();
